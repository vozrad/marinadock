<?php
/*
Template Name: ds_captain
description: display kapitanske zkousky page
autor: draftspot
*/
?>
<?php
get_header();
?>
<section class="ds_archive_section ds_archive_section_tax container-fluid" style="background-image:url(<?php echo get_field('slider_pozadi');?>);">
    <img src="<?php echo get_field('slider_pozadi_mobil');?>" alt="<?php echo get_field('slider_title');?>" class="ds_archive_section_bg_m">
	<div class="container">
...
<section class="ds_cap_section ds_cap_section_prep container-fluid">
	<div class="container">
		<div class="ds_cap_section_wrap">
            <div class="ds_cap_section_con">
                <h2><?php echo get_field('priprava_title');?></h2>
                <p><?php echo get_field('priprava_text');?></p>
                <div class="ds_cap_section_items">
                    <h3><?php echo get_field('priprava_predpoklady_title');?></h3>
                    <?php
                        $items=get_field('priprava_predpoklady');
                        if($items){
                            foreach($items as $p){
                                ?>
                ...
                <div class="ds_cap_section_items">
                    <h3><?php echo get_field('priprava_zkouska_title');?></h3>
                    <?php
                        $items=get_field('priprava_zkouska');
                        if($items){
                            foreach($items as $p){
                                ?>
                                <div class="ds_params_row d-flex">
            ...
            <div class="ds_cap_section_img">
                <figure>
                    <img src="<?php echo get_field('priprava_image');?>" class="" alt="">
                </figure>
            </div>
...
<section class="ds_cap_section ds_cap_section_offer container-fluid">
	<div class="container">
		...
		<div class="ds_cap_section_wrap">
            <div class="ds_cap_col">
                <h2><?php echo get_field('nabidky_title');?></h2>
                <p><?php echo get_field('nabidky_text');?></p>
                <a href="#" class="btn" alt="SEA RAY SPX 210"><span><?php echo get_field('nabidky_button_text');?></span></a>
            </div>
            <div class="ds_cap_col">
                <h3><?php echo get_field('nabidky_zkouska_title');?></h3>
                <p><?php echo get_field('nabidky_zkouska_text');?></p>
                <?php
					$items=get_field('nabidky_zkouska_obsahuje');
					if($items){
						foreach($items as $p){
							?>
							<div class="ds_params_row d-flex">
				...
				?>
                <p><?php echo get_field('nabidky_zkouska_spodni_text');?></p>
            </div>
            <div class="ds_cap_col">
                <h3><?php echo get_field('nabidky_priprava_i_zkouska_title');?></h3>
                <p><?php echo get_field('nabidky_priprava_i_zkouska_text');?></p>
                <?php
					$items=get_field('nabidky_priprava_i_zkouska_obsahuje');
					if($items){
						foreach($items as $p){
							?>
							<div class="ds_params_row d-flex">
				...
				?>
                <p><?php echo get_field('nabidky_priprava_i_zkouska_spodni_text');?></p>
            </div>
        </div>
	</div>
</section>
<section class="ds_cap_section ds_cap_section_popis container-fluid">
    <div class="container">
		<div class="ds_cap_section_wrap">
            <?php
				$items=get_field('popis_item');
				if($items){
                    $i=0;
					foreach($items as $p){
						?>
							<div class="ds_cap_col">
                                ...
                                if($i==2){
                                    ...
                                    <?php
                                        $points=get_field('popis_zkouska');
                                        foreach($points as $d){
                                            ?>
                                            <div class="ds_params_row d-flex">
                                                <div class="ds_params_img">
                                                ...
                                                <div class="ds_params_label">
                                                    <span><?php echo $d['item'];?></span>
                                                </div>
                                            </div>
                                            <?php
                                        }
                                    echo '</div>';
                                    echo '<p class="ds_bottom_text">'.get_field("popis_spodni_text").'</p>';
                                }
                                if($i==3){
                                    $map=get_field('popis_mapa');
                                    ?>
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12196.95065799561!2d14.396179568571528!3d50.00961167377762!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470b96bf73bdf3e3%3A0x16a4f3fdd6358d73!2sStrakonick%C3%A1%20876%2C%20159%2000%20Velk%C3%A1%20Chuchle!5e0!3m2!1scs!2scz!4v1710681719075!5m2!1scs!2scz" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        <!--<iframe style="border:none" src="https://frame.mapy.cz/s/baboracovo" width="1369" height="616" frameborder="0"></iframe>-->
                                    <?php
                                }
                                ?>
...
<section class="ds_cap_section ds_cap_section_cats container-fluid">
    <div class="container">
        <h2><?php echo get_field('kategorie_title');?></h2>
        <p><?php echo get_field('kategorie_text');?></p>
		<div class="ds_cap_section_wrap">
            <div class="ds_cap_col">
                <h3><?php echo get_field('kategorie_zakladni_title');?></h3>
                <?php
                    $items=get_field('kategorie_zakladni_items');
                    foreach($items as $it){
                        ?>
                        <div class="ds_params_wrap">
                            <h4><?php echo $it['title'];?></h4>
                            <p><?php echo $it['text'];?></p>
                            <?php
                            $points=$it['podminky'];
                            foreach($points as $d){
                                ?>
                    ...
                    ?>
                    <figure class="ds_params_wrap">
                        <img src="<?php echo get_field('kategorie_obrazek');?>" alt="<?php echo get_field('kategorie_title');?>">
                    </figure>
            </div>
            <div class="ds_cap_col">
            <h3><?php echo get_field('kategorie_rozsirene_title');?></h3>
            <?php
                $items=get_field('kategorie_rozsirene_items');
                foreach($items as $it){
                    ?>
                    <div class="ds_params_wrap">
                        <h4><?php echo $it['title'];?></h4>
...
<section class="ds_cap_section ds_cap_section_cenik container-fluid">
    ...
    <div class="container">
        ...
        <div class="ds_cap_section_wrap">
            <div class="ds_cap_col ds_cap_col_price">
                <div class="ds_cap_banner_wrap">
                    <h2 class="ds_cap_banner_text">
                        <?php echo get_field('cenik_banner_text');?>
                    </h2>
                    <div class="ds_cap_banner_img">
                        <img src="<?php echo get_field('cenik_banner_img');?>" class="" alt="<?php echo get_field('cenik_banner_text');?>">
                    </div>

                </div>
                <div class="ds_cap_cenik_wrap">
                    <h2><?php echo get_field('cenik_cenik_title');?></h2>
                    <?php
                    $items=get_field('cenik_kurzy');
                    foreach($items as $it){
                        ?>
                            <div class="ds_params_item">
                ...
                <div class="ds_cenik_bottom">
                    <p class="ds_cenik_bottom_italic"><?php echo get_field('cenik_cenik_text_kurziva');?></p>
                    <p class="ds_cenik_bottom_strong"><?php echo get_field('cenik_cenik_text_tucny');?></p>
                </div>
            </div>
            <div class="ds_cap_col ds_side_form">
                <?php get_template_part( 'template-parts/content', 'formS');?>
                <h2><?php echo get_field('cenik_terminy_title');?></h2>
                <p><?php echo get_field('cenik_terminy_text');?></p>
