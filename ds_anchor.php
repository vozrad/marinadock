<?php
/*
Template Name: ds_anchor
description: display kotveni page
autor: draftspot
*/
?>
<?php
...
<section class="ds_cap_section ds_cap_section_prep ds_cap_section_prep_serv container-fluid">
	<div class="container">
		<div class="ds_cap_section_wrap">
            <div class="ds_cap_section_con">
                <h2><?php echo get_field('popis_title');?></h2>
                <?php echo get_field('popis_text');?>
                <div class="ds_cap_section_items">
                    <?php $items=get_field('popis_offers');?>

                    <?php
                        if($items){
                            echo '<h3>'.get_field('popis_title_list').'</h3>';
                            foreach($items as $p){
                                ?>
            ...
            <p><?php echo get_field('popis_spodni_text');?></p>
            </div>
            <div class="ds_contact_right ds_side_form">
...
<section class="ds_cap_section ds_cap_section_cenik container-fluid">
    <div class="container">
        ...
        <?php
            ...
            if(!get_field('cenik_zobrazit_cenik')){
                ?>
                    <div class="ds_no_price_section_wrap ds_cap_section_cena_default">
                        <h2><?php echo get_field('cenik_title');?></h2>
                        <div>
                            <?php echo get_field('cenik_text_misto_ceniku');?>
                        </div>
                ...
                ?>
                <div class="ds_cap_section_wrap ds_cap_section_cena">
                    <div class="ds_cap_col ds_cap_col_price">
                        <h2><?php echo get_field('cenik_title');?></h2>
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_sezona_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_sezona_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_sezona_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_ostatni_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_ostatni_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_ostatni_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_marina_dock_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_marina_dock_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_marina_dock_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                                        <div class="ds_params_label">
                                            <?php if($d['label']){ echo $d['label']; } ?>
                                        </div>
                                        <div class="ds_params_value">
                                            <span><?php if($d['value']){ echo $d['value']; } ?></span>
                                        </div>
                                    </div>
                                    <?php
                                }
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_marina_slapy_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_marina_slapy_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_marina_slapy_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_marina_smichov_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_marina_smichov_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_marina_smichov_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_marina_davle_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_marina_davle_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_marina_davle_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                        ...
                        <div class="ds_cap_cenik_wrap">
                            <?php
                                if(get_field('cenik_transport_title')){
                                    ?>
                                        <h3><?php echo get_field('cenik_transport_title');?></h3>
                                    <?php
                                }
                            $items=get_field('cenik_transport_items');
                            if($items){
                                foreach($items as $d){
                                ?>
                                    <div class="ds_params_row d-flex">
                            ...
                            <div class="ds_cenik_bottom">
                                <p class="ds_cenik_bottom_italic"><?php echo get_field('cenik_spodni_text');?></p>
                            </div>
                        </div>
                    </div>
                    <div class="ds_cap_col ds_side_map">
...
<section class="ds_about_section ds_about_section_gal ds_about_section_gal_serv">
    ...
    <div class="container">
        <?php
        $gall= get_field('galerie_gallery');
        ?>
        <div class="ds_about_gal_wrap">
            <div class="ds_about_gal_col">
                <figure>
                    <img class="" src="<?php echo $gall[0]['sizes']['large']?>" alt="">
                </figure>
            ...
            <div class="ds_about_gal_col2">
                <div class="ds_about_gal_row">
                    <figure>
                        <img class="" src="<?php echo $gall[1]['sizes']['large']?>" alt="">
                    </figure>
                </div>
                <div class="ds_about_gal_row2">
                    <div class="ds_about_gal_subcol">
                        <figure>
                            <img class="" src="<?php echo $gall[2]['sizes']['large']?>" alt="">
                        </figure>
                    </div>
                    <div class="ds_about_gal_subcol">
                        <figure>
                            <img class="" src="<?php echo $gall[3]['sizes']['large']?>" alt="">
                        </figure>
                    </div>
                </div>
            </div>
