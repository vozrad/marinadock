 ...
 */
 ...
 get_header();
 ?>
<div class="ds_single_post container-fluid">
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('container'); ?>>
        <header class="ds_post_header">
            <div class="ds_post_image">
                <?php
                    the_post_thumbnail('full', array( 'class' => 'ds_single_img w-100' ));
                ?>
            </div>
        </header>
        <div class="ds_post_wrap d-flex">
            <div class="ds_post_left">

                <div class="ds_post_date">
                    <?php
                        the_time( 'j. F Y' );
                    ?>
                </div>
                <div class="ds_post_title">
                    <?php
                        the_title( '<h1 class="ds_single_title">', '</h1>' );
                    ?>
                </div>
                ...
                <div class="ds_post_gallery">
                    <div class="ds_post_gallery_wrap">
                        <?php
                            $gallery=get_field('galerie',get_the_id());
                            foreach($gallery as $g){

                                ?>
                                <div class="ds_post_gallery_item">
                                    <img class="lightboxed" data-link="<?php echo $g['url'];?>" rel="group2" src="<?php echo $g['sizes']['medium'];?>" alt="galerie">
                                </div>
                                <?php
                            }
                        ?>
                ...
                <div class="ds_post_meta">
                    <div class="ds_post_meta_wrap d-flex">
                        <div class="ds_post_meta_left d-flex">
                            <?php
                                $tags=wp_get_post_tags(get_the_id());
                                foreach($tags as $c){
                                    ?>
                                        <div class="ds_tag_wrap">
                                            <div class="ds_tag_name" data-id="<?php echo $c->term_id;?>"><a href="/blog?tag=<?php echo $c->term_id;?>" alt="<?php echo $c->name;?>"><?php echo $c->name;?></a></div>
                                        </div>
                                    <?php
                                }
                            ?>
                        </div>
                        <div class="ds_post_meta_right">
                            <?php echo do_shortcode('[Sassy_Social_Share  title="Sdílet"]');?>
                        </div>
                    </div>
                </div>
                <div class="ds_post_author">
                    <div class="ds_post_author_wrap d-flex">
                        <div class="ds_post_author_left">
                            <?php
                                $aid=$post->post_author;
                                echo get_avatar( $aid , $size = '112', $default = '', $alt = '', $args = array( 'class' => 'ds_author_img' ) );
                            ?>
                        </div>
                        <div class="ds_post_author_right">
                            <div class="ds_post_author_row ds_post_author_row_author">Autor</div>
                            <div class="ds_post_author_row ds_post_author_row_name"><?php echo get_the_author_meta( 'nicename',$aid );?></div>
                            <div class="ds_post_author_row ds_post_author_row_text"><?php echo get_the_author_meta( 'description',$aid );?></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="ds_post_right ds_blog_right">
                <div class="ds_search_wrap">
                    <div class="ds_search_input_wrap d-flex">
                        <input type="text" class="ds_search_input2" value="" placeholder="Vyhledat..." autocomplete="true">
                        <a href="" class="ds_search_submit2"><img src="/wp-content/uploads/2024/03/lupa.svg" alt=""></a>
                    </div>
                </div>
                        ...
                        foreach($cats as $c){
                            ?>
                                <div class="ds_cats_row d-flex">
                                    <div class="ds_cats_name" data-id="<?php echo $c->term_id;?>"><a href="/blog?cat=<?php echo $c->term_id;?>" alt="<?php echo $c->name;?>"><?php echo $c->name;?></a></div>
